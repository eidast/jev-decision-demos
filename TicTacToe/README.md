...
See the [visual guide](docs/VISUAL_GUIDE.md) for the game journey, board indices, candidate filtering, and result states.

![Schematic welcome, Jev decision, and tie](docs/assets/game-states.svg)
